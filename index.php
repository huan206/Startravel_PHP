...
<body id="main-homepage">
	...
	height:100%;">
                ...
                <li class="item-2" style="background:linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(images/ĐN.jpg) 50% 0%;
	background-size:cover;
	height:100%;">
                    <div class=" meta">
                        <div class="container">
                                ...
                                if(!empty($rows)){
                                    ...
                                    <div class='main-block hotel-block'>
                                            ...
                                            <div class='main-info hotel-info'>
                                                <div class='arrow'>
                                                    <div data-toggle='modal' data-target='#myModalHot' onclick='chitiet_hot(' $id_hot')'><i class='fa fa-angle-right'></i></div>
                                                </div>
                            ...
                            $rows = $tourOffer->fetch($sql);
                                if(!empty($rows)){
                                    ...
                                    <div class='main-block hotel-block'>
                                            ...
                                            <div class='main-info hotel-info'>
                                                <div class='arrow'>
                                                    <div data-toggle='modal' data-target='#myModalHot' onclick='chitiet_hot(' $id_offer')'><i class='fa fa-angle-right'></i></div>
                                                </div>
                                                <div class='main-title hotel-title'>
                                                    <a href'#'> $name_offer</a>
                                            ...
                                            echo "<div class='col-sm-6 col-md-4'>
                                                    <div class='main-block vehicle-block'>
                                                        ...
                                                        <div class='offer-price-2'>
                                                            <ul class='list-unstyled'>
                                                                <li class='price'>$price_capital<a href='#'><span class='arrow'><i class='fa fa-angle-right'></i></span></a></li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div class='main-info vehicle-info'>
                                                            <div class='main-title vehicle-title'>
                                                                ...
                                                                <div class='rating'>
                                                                    ...
                                                                    <span><i class='fa fa-star orange'></i></span>
                                                                    <span><i class='fa fa-star orange'></i></span>
                                                                    <span><i class=' fa-star lightgrey'></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="view-all text-center">
                        <a href="blog-listing-right-sidebar.html" class="btn btn-orange">View All</a>
                    </div>
                    <!-- end view-all -->
                </div>
                <!-- end columns -->
