    ...
    <section class="innerpage-wrapper">
        <div id="registration" class="innerpage-section-padding">
            <div class="container">
                        ...
                        <div class="flex-content">
                            <div class="custom-form custom-form-fields">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Username" id="user" name="account_name" required/>
               ...
               echo 'show();';
           ?>">
                                    <button class="btn btn-orange btn-block" id="submit" name="submit">submit</button>
                                </form>

                                <div class="other-links">
                                    <p class="link-line">Already Have An Account ? <a href="login.html">Login Here</a></p>
                                </div>
                                <!-- end other-links -->
                            </div>
                            <!-- end custom-form -->
