                        ...
                        <div class="flex-content">
                            <div class="custom-form custom-form-fields">
                                ...
                                <form action="" method="post">
                                    ...
                                    <input type="submit" class="btn btn-orange btn-block" id="register" placeholder="Register" name="register">
                                </form>
                              
                                <div class="other-links">
                                    <p class="link-line">Already Have An Account ? <a href="login.html">Login Here</a></p>
                                    <p class="link-line">New Here ? <a href="registration.html">Join Us</a></p>
                                </div>
                                <!-- end other-links -->
                            </div>
                            <!-- end custom-form -->
